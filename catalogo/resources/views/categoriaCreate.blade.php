...
<main>
    <div class="mx-auto max-w-4xl py-12 px-8">
        ...
        <h1 class="text-2xl font-bold">Alta de una categoría</h1>
            ...
            <form action="" method="post">
                ...
                <div class="p-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="catNombre" id="catNombre"
