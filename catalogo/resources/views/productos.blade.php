...
<main>
    <div class="mx-auto max-w-4xl py-12 px-8">
        ...
        <h1 class="text-2xl mb-3 font-bold">Panel de administración de productos</h1>
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <td class="py-4 px-6 text-sm font-medium text-right ">
                            <a href="/producto/edit/{{ 'idProducto' }}" class="text-gray-700 dark:text-gray-400 hover:underline py-3 flex">
                            ...
                            <a href="/producto/delete/{{ 'idProducto' }}" class="text-gray-700 dark:text-gray-400 hover:underline py-3 flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2 align-middle">
